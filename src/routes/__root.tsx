...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pranadh Bhat — Futuristic Portfolio" },
      { property: "og:description", content: "Tech Enthusiast | Gamer | Science Lover — explore my neon-lit world." },
